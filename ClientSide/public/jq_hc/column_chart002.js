$(function () {
    $(document).ready(function () {
        ...
        $('#chart-container-002').highcharts({
            chart: {
                ...
                events: {
                    load: function () {
						...
						socket.on('wiki:data', function(data){
                            ...
                            series0.addPoint([data.time, data.fr], true, true);
                            series1.addPoint([data.time, data.es], true, true);
                            series2.addPoint([data.time, data.de], true, true);
                            series3.addPoint([data.time, data.ru], true, true);
						});
